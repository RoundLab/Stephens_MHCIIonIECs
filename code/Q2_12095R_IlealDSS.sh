...
SCRATCH=
# Main results directory for core files (table, tree, taxonomy) and analyses. ResultDir is 16S/results/12095R_IlealDSS/ for this run.
ResultDir=
...
MANIFEST=
# A metadata map file. Used the file 16S/metadata/map_12095R_IlealDSS.txt for this run.
MAP=
